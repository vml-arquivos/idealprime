...
export default function BusinessPortal() {
  ...
  const catalogCategories = useMemo(() => {
    ...
    return Array.from(new Set(list.map((item) => item.category_label?.trim()).filter(Boolean) as string[])).sort((a, b) => a.localeCompare(b, "pt-BR"));
  }, [catalog.data]);
  ...
  }, [catalog.data, query, categoryFilter]);
